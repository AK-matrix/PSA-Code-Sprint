  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <aside
        ...
        } border-r border-slate-700 bg-slate-900/50 backdrop-blur-sm transition-all duration-300 flex flex-col`}
      >
        {/* Logo */}
          ...
          <div className="flex items-center gap-3">
            ...
            {sidebarOpen && (
              <div className="flex-1">
                <h1 className="text-lg font-bold text-white">PSA AI</h1>
                <p className="text-xs text-slate-400">Co-Pilot</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="p-4 border-t border-slate-700">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-lg text-slate-400 hover:bg-slate-800 hover:text-white transition-all"
          >
            ...
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-2xl font-bold text-white">
                  ...
                  {activeSection === "workflow" && "Multi-Agent Workflow"}
                  {activeSection === "settings" && "System Settings"}
                </h2>
                <p className="text-sm text-slate-400 mt-1">
                  {activeSection === "dashboard" &&
                    "Process alerts and manage escalations with AI"}
                  {activeSection === "workflow" &&
                    "Understand how our AI agents work together"}
                  {activeSection === "settings" && "Configure your system preferences"}
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-3xl font-bold text-white mt-1">{stats.totalAlerts}</p>
                      </div>
                ...
                <Card className="border-slate-700 bg-slate-800/50">
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm text-slate-400">Processed Today</p>
                        <p className="text-3xl font-bold text-white mt-1">{stats.processedToday}</p>
                      </div>
              ...
              <Card className="border-slate-700 bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur">
                <CardHeader>
                  <div className="flex items-center gap-2">
                    ...
                    <CardTitle className="text-white">Process New Alert</CardTitle>
                  </div>
                  <CardDescription className="text-slate-400">
                    Enter a PSA alert to trigger intelligent triage and automated escalation
                  </CardDescription>
                </CardHeader>
